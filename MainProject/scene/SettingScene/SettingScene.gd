...
var SettingDispatcher = TypeUnit.type("SettingDispatcher")
var SettingModel = TypeUnit.type("SettingModel")
var SettingRender = TypeUnit.type("SettingRender")
var SettingService = TypeUnit.type("SettingService")
...
func _init():
	is_registered = false
	scene_dispatcher = SettingDispatcher.new()
	scene_model = null
	scene_render = SettingRender.new()
	scene_service = SettingService.new()
	__setRef()
...
func loadScript(script_tree):
	...
	scene_model = script_tree.getObject("scene_model", SettingModel)
