...
func test_buildResourceUnit():
	...
	# sub_menu
	resource_unit.addTexture("sub_menu", "sub_menu", "background_rect", "res://asserts/sub_menu/background_rect.png")
	...
	resource_unit.addTexture("sub_menu", "LoadButton", "texture_normal", "res://asserts/sub_menu/sub_menu_btn.png")
	...
	resource_unit.addTexture("sub_menu", "MainMenuButton", "texture_normal", "res://asserts/sub_menu/sub_menu_btn.png")
